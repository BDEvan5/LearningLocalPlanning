...
class StdPP:
    ...
    def act_pp(self, pose, lookahead_point):
        pose_th = obs[2]
...
class WptTrain(BaseWpt):
    def __init__(self, agent_name, map_name, sim_conf, load=False, h_size=200):
        BaseWpt.__init__(self, agent_name, map_name, sim_conf)
    ...
    def plan_act(self, obs):
        ...
        new_pt = self.calculate_new_point(nn_action)

        steering_angle = super().act_pp(state, new_pt)
