...
from LearningLocalPlanning.NavUtils.SuperSafetySystem import run_safety_check
...
class SerialVehicleTrain(SerialBase):
    ...
    def plan_act(self, obs):
        ...
        self.action, self.mod_flag = run_safety_check(obs, self.action, self.max_steer, self.max_d_dot)
...
class SerialVehicleTest(SerialBase):
    ...
    def plan_act(self, obs):
        ...
        action, _ = run_safety_check(obs, action, self.max_steer, self.max_d_dot)
